...
function authStatus(code) {
  ...
  if (['RESULT_PERMISSION_DENIED', 'RESULT_CLASS_SCOPE_REQUIRED', 'RESULT_CLASS_SCOPE_DENIED', 'RESULT_SUBJECT_SCOPE_REQUIRED', 'RESULT_SUBJECT_SCOPE_DENIED', 'RESULT_ACCESS_NOT_GRANTED', 'RESULT_SCOPE_CONTEXT_REQUIRED', 'RESULT_ACADEMIC_CONTEXT_REQUIRED', 'RESULT_ACADEMIC_SESSION_NOT_ACTIVE', 'RESULT_TERM_NOT_ACTIVE', 'RESULT_TERM_INVALID', 'RESULT_CONTEXT_INVALID', 'RESULT_CONTEXT_MISMATCH', 'RESULT_CLASS_NOT_ASSIGNED', 'RESULT_SUBJECT_NOT_ASSIGNED', 'RESULT_CORRECTION_SOURCE_NOT_ALLOWED', 'RESULT_STAFF_WRITE_DISABLED', 'RESULT_STAFF_WRITE_TARGET_REQUIRED', 'RESULT_STAFF_WRITE_TARGET_NOT_FOUND'].includes(code)) return 403;
